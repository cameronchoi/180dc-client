...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to 180 Degrees Consulting.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to 180 Degrees Consulting,
            accessible from{" "}
            <a
              href="https://www.180dcusyd.org"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.180dcusyd.org
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: sydney@180dc.org</li>
      </ul>
    </>
  );
};
